                                            ...
                                            <div className="form-group mb-4">
                                                ...
                                                <div className="input-group">
                                                    ...
                                                    <button type="button" className="btn btn-secondary d-inline-flex align-items-center me-2" onClick={onFavoriteClick} >
                                                        <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-xs" viewBox="0 0 20 20" fill={getStarFillColor()} onClick={onFavoriteClick}  >
                                    ...
                                    <div className="row">
                                        <div className="col-md-6 mb-3">
                                            <div className="form-group">
                                                ...
                                                <input type="number" className="form-control" id="basePrecision" placeholder="8" required defaultValue={symbol.basePrecision} onChange={onInputChange} />
                                            </div>
                                        </div>
                                        <div className="col-md-6 mb-3">
                                            <div className="form-group">
                                                <label htmlFor="quotePrecision">Quote Precision:</label>
                                                <input type="number" className="form-control" id="quotePrecision" placeholder="8" defaultValue={symbol.quotePrecision} onChange={onInputChange} required />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="row">
                                        <div className="col-md-6 mb-3">
                                            <div className="form-group">
                                                ...
                                                <input type="text" className="form-control" id="minNotional" placeholder="0.1" required defaultValue={symbol.minNotional} onChange={onInputChange} />
                                            </div>
                                        </div>
                                        <div className="col-md-6 mb-3">
                                            <div className="form-group">
                                                <label htmlFor="minLotSize">Min Lot Size:</label>
                                                <input type="text" className="form-control" id="minLoteSize" placeholder="0.1" required defaultValue={symbol.minLoteSize} onChange={onInputChange} />
                                            </div>
                                        </div>
                                    </div>
