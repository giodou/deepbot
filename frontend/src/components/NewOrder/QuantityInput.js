    ...
    const quantityInput = useMemo(() => (
        <div className="form-group">
            ...
            <div className="input-group">
                ...
                <input type="number" id={props.id} ref={inputQuantity} className="form-control" placeholder={props.symbol.minLoteSize ? `Min. ${props.symbol.minLoteSize}` : ''} onChange={props.onChange} />
            </div>
        </div>
